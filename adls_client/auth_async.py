"""
Async service principal auth using httpx.
...
class ServicePrincipalAuthAsync(ServicePrincipalAuthBase):
    def __init__(self, tenant_id: str, client_id: str, client_secret: str):
        super().__init__(tenant_id, client_id, client_secret)

    async def fetch_token(self):
        """Fetch a new OAuth2 token from Azure AD using client credentials (async)."""
